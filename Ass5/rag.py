...
print(f"\nExample document abstract: {documents.iloc[0].abstract}")
...
#Split the text into chunks smartly and save the metadata
...
# set to small number for testing, None for full dataset, all questions
SAMPLE_SIZE = None
...
print("TASK 2: Evaluating baseline without context")
...
print("\nTASK 3: Evaluating retrieval quality\n")
